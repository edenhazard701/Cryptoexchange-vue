  ...
  <el-main class="login-main">
    ...
    <div class="logon_box">
      ...
      <div style="text-align: center;margin-top:20px">
            <el-button round style="background-color:#3f50b4;color:white;width:250px;height: 55px;margin-top:50px;" @click="checkCert">마이키핀 계정으로 로그인</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    //self.myKeepInCert()
      ...
      self.stateData = '0529688c-92c7-7d03-7272-2156bc843e7e'
      self.codeData = '56c6ea4b-2e2c-413e-bdde-9273eb2819ce'    
    ...
    getAccLoginInfo()
    {
        ...
        // pre login 처리
          self.$store.dispatch('preLogin', {
            ...
            console.log('preLogin Success user_id:' + window.loginObj['user_id'])
            console.log('preLogin Success auth_ci:' + window.loginObj['auth_ci'])
