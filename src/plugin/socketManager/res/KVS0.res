BEGIN_FUNCTION_MAP
    .Feed, (KVS0)KVX 체결, KVS0, key=15, keycnt=1000, bufcnt=200, group=1;
    BEGIN_DATA_MAP
    InBlock,입력,input;
    begin
    ...
    체결수량              , execqty              , execqty              , char ,    20;
    누적거래량            , cumdealqty           , cumdealqty           , double ,    20;
    전일누적거래량        , precumdealqty        , precumdealqty        , double ,    20;
    누적거래대금          , cumdealcost          , cumdealcost          , char ,    20;
    전일누적거래대금      , precumdealcost       , precumdealcost       , char ,    20;
    매도호가              , ask                  , ask                  , double ,    20;
    매수호가              , bid                  , bid                  , double ,    20;
    매도호가 잔량         , askrest              , askrest              , double ,    20;
    매수호가 잔량         , bidrest              , bidrest              , double ,    20;
