BEGIN_FUNCTION_MAP
	.Func,(s0051)가상화폐 서버자동주문 감시 내역 조회,s0051,headtype=B;
	BEGIN_DATA_MAP
		s0051InBlock,입력,input;
		begin
		...
		s0051OutBlock1,출력,output;
		begin
			츨력개수              , out_cnt            , out_cnt             , char   ,   5;
		end
		s0051OutBlock2,출력,output,occurs;
		begin
			USER ID               ,    user_id         ,    user_id          ,  char  ,  10;
			...
			처리내용              ,    ordr_prc_stts   ,    ordr_prc_stts    ,  char  ,  20;
			...
			매체구분              ,    md_cd           ,    md_cd            ,  char  ,   3;
			동작설정              ,    at_mnl_ccd      ,    at_mnl_ccd       ,  char  ,   1;
			상태변경일시          ,    st_upt_dy_tm    ,    st_upt_dy_tm     ,  char  ,  16;
			주문조건상세          ,    ordr_cond_msg   ,    ordr_cond_msg    ,  char  , 100;
		end
	END_DATA_MAP
END_FUNCTION_MAP
