BEGIN_FUNCTION_MAP
	.Func,(s0040)가상화폐 잔고청산주문설정 조건 단건 조회,s0040,headtype=B;
	BEGIN_DATA_MAP
		s0040InBlock,입력,input;
		begin
		...
		begin
			...
			TS이익실현설정여부        ,  t_s_prft_rstn_est_prc_clsf,  t_s_prft_rstn_est_prc_clsf, char    ,  1;
			TS이익실현설정여부        ,  t_s_prft_rstn_est_unt     ,  t_s_prft_rstn_est_unt     , char    ,  1;
